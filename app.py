...
TL = Candidate(
    "Thanos and Loki", "Thanos and Loki, the most powerful couple!", "villain"
)
HV = Candidate(
    "Hela and Venom",
    "Hela destroyed Thor's hammer, and Venom got Eminem's help!",
    "villain",
)
...
DS = Candidate(
    "Deadpool and Starlord",
    "Two of the most talkative heros in the Marvel universe!",
    "hero",
)
